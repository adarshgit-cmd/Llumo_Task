"""
Django settings for llumo project.
...
SECRET_KEY = 'django-insecure-r!=b$4$$dqn@3mc1x&nl1_t(w$ao_157)cbyl8u^x#^k0$op*u'
...
WSGI_APPLICATION = 'llumo.wsgi.application'
